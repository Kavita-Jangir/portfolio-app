...
class Addproject extends Component {
    ...
    onSubmit= async (handler, event)=>{
        ...
        const response = await axios.post("http://127.0.0.1:8080/api/project",newProject)
            ...
            {(value)=>{
                 ...
                 return (
                   <div className="container py-5 my-5">
                         <h1 className='text-center my-5 font-weight-light'>Add <span className='text-info'> Project </span>
                         </h1>
                         <div className="row px-3">
                             <div className="col-12 col-lg-6">
                                 <form onSubmit={this.onSubmit.bind(this, handler)}>
                                     ...
                                     <MarkdownEditor                        onChange={this.onBodyChange}
                                      /><br/>
